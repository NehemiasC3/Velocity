...
import { Settings, Shield, Bell, Database, Key, Globe, Server } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
          ...
          <p className="text-sm text-slate-500">
            URL base, clave API y sincronización automática de contratos y clientes.
          </p>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-3">
          ...
          <p className="text-sm text-slate-500">
            Rastreo proactivo de errores en backend y frontend en tiempo real.
          </p>
