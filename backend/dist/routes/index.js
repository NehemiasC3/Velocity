...
const contractsRoutes_1 = __importDefault(require("./contractsRoutes"));
...
apiRouter.use(contractsRoutes_1.default);
...
apiRouter.use(systemRoutes_1.default);
apiRouter.use('/v1', inventoryRoutes_1.default);
apiRouter.use('/v1', notificationRoutes_1.default);
