...
class ReportService {
    ...
    constructor() {
        ...
        setInterval(() => {
            ...
            if (hh === 23 && mm === 59 && this.lastReportDay !== todayStr) {
                ...
                this.sendDailyReportEmail().catch((e) => console.error('[ReportService] Error en envío automático nocturno:', e.message));
            }
        }, 60000);
    }
    async sendDailyReportEmail() {
        ...
        const recipient = db.settings?.reportRecipientEmail ||
